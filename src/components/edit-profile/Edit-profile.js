...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProp) {
    ...
    if (
      nextProp.profile === undefined ||
      nextProp.profile.profile === null ||
      nextProp.profile.profile === undefined ||
      nextProp.profile.loading === true
    ) {
      return <Spinner />;
    }
    if (nextProp.profile.profile) {
      ...
      profile.language =
        profile.language.length > 0 ? profile.language.join(",") : null;

      // profile.handle = !isEmpty(profile.handle) ? profile.handle : "";
      // profile.gender = !isEmpty(profile.gender) ? profile.gender : "";
      // profile.birth = !isEmpty(profile.birth) ? profile.birth : "";
      profile.religion = !isEmpty(profile.religion) ? profile.religion : "";
      profile.interestedIn = !isEmpty(profile.interestedIn)
        ...
        <div>
          <div className="input-group mb-3">
            ...
            <input
              type="text"
              className={className(
                "form-control form-control-lg social-input",
                {
